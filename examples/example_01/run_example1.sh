...
#--------------------------------------------------------
../../bin/daycli_encoder1 -i ./DAYCLI_82191_f1.txt -o ./DAYCLI_82191.bufr
...
#---------------------------------------------------------------------------
../../bin/daycli_decoder -i ./DAYCLI_82191.bufr -o ./DAYCLI_82191.decoded_f2.txt
...
#--------------------------------------------------------------
../../bin/bufrdump -i ./DAYCLI_82191.bufr -o DAYCLI_82191.bufrdump-decoded.txt
../../bin/bufrdump -i ./DAYCLI_MF_0-20000-0-71805_202204.bufr -o ./DAYCLI_MF_0-20000-0-71805_202204.bufrdump-decoded.txt
