...
Note: The DAYCLI messages can be decoded by any available BUFR software, as well as by the daycli_decoder and/or bufrdump software included in this toolkit.

Simple exaples is also included 
